...
public class AvroItemEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static AvroItemEvent.Builder newBuilder() {
    return new AvroItemEvent.Builder();
  }
   ...
   * @return A new AvroItemEvent RecordBuilder
   */
  public static AvroItemEvent.Builder newBuilder(AvroItemEvent.Builder other) {
    return new AvroItemEvent.Builder(other);
  }
   ...
   * @return A new AvroItemEvent RecordBuilder
   */
  public static AvroItemEvent.Builder newBuilder(AvroItemEvent other) {
    return new AvroItemEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroItemEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(AvroItemEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(AvroItemEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemEvent.Builder setEventId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemEvent.Builder clearEventId() {
      eventId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemEvent.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemEvent.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemEvent.Builder setData(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemEvent.Builder clearData() {
      data = null;
