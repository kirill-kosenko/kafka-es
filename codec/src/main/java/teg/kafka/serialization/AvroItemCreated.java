...
public class AvroItemCreated extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -447432346619444058L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroItemCreated\",\"namespace\":\"kafka.serialization\",\"fields\":[{\"name\":\"itemId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"description\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static AvroItemCreated.Builder newBuilder() {
    return new AvroItemCreated.Builder();
  }
   ...
   * @return A new AvroItemCreated RecordBuilder
   */
  public static AvroItemCreated.Builder newBuilder(AvroItemCreated.Builder other) {
    return new AvroItemCreated.Builder(other);
  }
   ...
   * @return A new AvroItemCreated RecordBuilder
   */
  public static AvroItemCreated.Builder newBuilder(AvroItemCreated other) {
    return new AvroItemCreated.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroItemCreated>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(AvroItemCreated.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(AvroItemCreated other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.itemId)) {
        this.itemId = data().deepCopy(fields()[0].schema(), other.itemId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemCreated.Builder setItemId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemCreated.Builder clearItemId() {
      itemId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemCreated.Builder setDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemCreated.Builder clearDescription() {
      description = null;
