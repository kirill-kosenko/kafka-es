...
public class AvroItemMovedToList extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5218637130924337108L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroItemMovedToList\",\"namespace\":\"kafka.serialization\",\"fields\":[{\"name\":\"itemId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"list\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static AvroItemMovedToList.Builder newBuilder() {
    return new AvroItemMovedToList.Builder();
  }
   ...
   * @return A new AvroItemMovedToList RecordBuilder
   */
  public static AvroItemMovedToList.Builder newBuilder(AvroItemMovedToList.Builder other) {
    return new AvroItemMovedToList.Builder(other);
  }
   ...
   * @return A new AvroItemMovedToList RecordBuilder
   */
  public static AvroItemMovedToList.Builder newBuilder(AvroItemMovedToList other) {
    return new AvroItemMovedToList.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroItemMovedToList>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(AvroItemMovedToList.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(AvroItemMovedToList other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.itemId)) {
        this.itemId = data().deepCopy(fields()[0].schema(), other.itemId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemMovedToList.Builder setItemId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemMovedToList.Builder clearItemId() {
      itemId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemMovedToList.Builder setList(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroItemMovedToList.Builder clearList() {
      list = null;
