...
public class AvroDueDateAssigned extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8405045459659107926L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroDueDateAssigned\",\"namespace\":\"kafka.serialization\",\"fields\":[{\"name\":\"itemId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"dueDate\",\"type\":\"long\"}]}");
   ...
   */
  public static AvroDueDateAssigned.Builder newBuilder() {
    return new AvroDueDateAssigned.Builder();
  }
   ...
   * @return A new AvroDueDateAssigned RecordBuilder
   */
  public static AvroDueDateAssigned.Builder newBuilder(AvroDueDateAssigned.Builder other) {
    return new AvroDueDateAssigned.Builder(other);
  }
   ...
   * @return A new AvroDueDateAssigned RecordBuilder
   */
  public static AvroDueDateAssigned.Builder newBuilder(AvroDueDateAssigned other) {
    return new AvroDueDateAssigned.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroDueDateAssigned>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(AvroDueDateAssigned.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(AvroDueDateAssigned other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.itemId)) {
        this.itemId = data().deepCopy(fields()[0].schema(), other.itemId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroDueDateAssigned.Builder setItemId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroDueDateAssigned.Builder clearItemId() {
      itemId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroDueDateAssigned.Builder setDueDate(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroDueDateAssigned.Builder clearDueDate() {
